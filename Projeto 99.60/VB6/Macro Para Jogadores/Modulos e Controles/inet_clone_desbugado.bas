...
Public Sub SetProgressBar(Pronto As Long)
    If Pronto = 0 Then Exit Sub
    DoEvents
    
    If Inicio.PB.Visible = False Then Inicio.PB.Visible = True
    If Inicio.PB.ShowText = False Then Inicio.PB.ShowText = True
    
    If Tamanho = 0 Then
        Inicio.PB.Value = Inicio.PB.Max
        Exit Sub
    End If
    
    Inicio.PB.Value = (Pronto / Tamanho) * 100
End Sub
            ...
            If hInternetSession Then
                ...
                If hInternetOpen Then
                    ...
                    Do While bDoLoop
                        ...
                        If bProgressBar Then Call SetProgressBar(lTotalBytesRead)
