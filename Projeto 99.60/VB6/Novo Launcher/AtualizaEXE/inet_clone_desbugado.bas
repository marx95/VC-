    ...
    If Len(sURLfrom) Or Len(sFileName) Then
        ...
        If Left$(LCase(sURLfrom), 7) = "http://" Or Left$(LCase(sURLfrom), 6) = "ftp://" Then
            ...
            If hInternetSession Then
                ...
                hInternetOpen = InternetOpenUrl(hInternetSession, strURL, vbNullString, 0, INTERNET_FLAG_EXISTING_CONNECT + INTERNET_FLAG_NO_CACHE_WRITE, 0)
                If bCancel = True Then
                    GoTo Exit_Jump
                End If
                ' Check File Opened
                ...
                If hInternetOpen Then
                    ...
                    Do While bDoLoop
                        ...
                        If bProgressBar Then
                            'Call ProgressBar(TamanhoTotal, lTotalBytesRead, sFileName)
                        End If
