...
{
	DWORD OldProtect;
	if(VirtualProtect(LPVOID(GS_BASE), 2670699, PAGE_EXECUTE_READWRITE, &OldProtect) == false)
	{
		MessageBoxA(0, "Erro ao iniciar o Modulo da DLL do MarxD", "Ocorreu um erro - WzAg.dll", 0);
		::ExitProcess(0);
	}
}
