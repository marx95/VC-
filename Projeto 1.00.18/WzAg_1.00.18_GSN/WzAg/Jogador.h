...
struct OBJECTSTRUCT 
{
	...
	int		FrustrumX[4];
	int		FrustrumY[4];
	VIEWPORT_STRUCT VpPlayer[75];	// 3B0
	VIEWPORT_PLAYER_STRUCT VpPlayer2[75];	// 734
	int		VPCount;
	int		VPCount2;
	char	sHD[480];
	short	sHDCount;
	int m_IfState; /*struct tagInterfaceState m_IfState;*/
...
struct CustomStruct
{
	...
	int UltimoNpcIndex;
	int Atualizar_Delay;
	int Necessario_Atualizar;

	int Level_Max_Msg;
};
extern CustomStruct gObjCustom[7400];
