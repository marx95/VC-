...
int wzag::AGRequestData(int NoneUse,int GetType)  
{
        ...
        case 0x00:
                ...
                break;
        case 0x01: // - <- Protocolo Kor Não usa
				sprintf_s(filename, "..\\data\\Lang\\%s\\item(%s).txt", Lang, Lang);
                break;
                //Skill
        case 0x02:
        ...
        case 0x09:
				if(sizeof(OBJECTSTRUCT) == 6504)
				{
					sprintf_s(filename, "..\\data\\MonsterSetBase.txt");
				}else
				{
					sprintf_s(filename, "..\\data\\MonsterSetBase_CS.txt");
				}
                break;
                //Reservado GameGuard
        case 0x0A:
                ...
                //Shops
        case 0x0B:
				sprintf_s(filename, "..\\data\\Shops\\Shop0.txt");
                break;
        case 0x0C:
               sprintf_s(filename, "..\\data\\Shops\\Shop1.txt");
                break;
        case 0x0D:
                sprintf_s(filename, "..\\data\\Shops\\Shop2.txt");
                break;
        case 0x0E:
                sprintf_s(filename, "..\\data\\Shops\\Shop3.txt");
                break;
        case 0x0F:
                sprintf_s(filename, "..\\data\\Shops\\Shop4.txt");
                break;
        case 0x10:
                sprintf_s(filename, "..\\data\\Shops\\Shop5.txt");
                break;
        case 0x11:
                sprintf_s(filename, "..\\data\\Shops\\Shop6.txt");
                break;
        case 0x12:
                sprintf_s(filename, "..\\data\\Shops\\Shop7.txt");
                break;
        case 0x13:
               sprintf_s(filename, "..\\data\\Shops\\Shop8.txt");
                break;
        case 0x14:
                sprintf_s(filename, "..\\data\\Shops\\Shop9.txt");
                break;
        case 0x15:
                sprintf_s(filename, "..\\data\\Shops\\Shop10.txt");
                break;          
        case 0x16:
                sprintf_s(filename, "..\\data\\Shops\\Shop11.txt");
                break;
        case 0x17:
                sprintf_s(filename, "..\\data\\Shops\\Shop12.txt");
                break;
        ...
        case 0x1D:
                ...
                //Novo para Season3
        case 0x1E:
               sprintf_s(filename, "..\\data\\Shops\\Shop13.txt");
                break;
                //Verificações
        default:
